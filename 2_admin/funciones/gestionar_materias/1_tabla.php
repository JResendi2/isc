 ...
 *****************************************************************************/
$consultar = "select materias.id, materias.nombre, clave from materias";
...
<nav>
	...
	<section>
		<h2 class="subtitulo">Agrega las materias</h2>
				...
				<table>
					...
					while ($registro = mysqli_fetch_array($resultado_de_la_consulta)) { // Mientras existan registros...
						...
						<tr> 
							...
							<td><a href='3_modificar.php?idM=" . $registro["id"] . "'> Modificar</a> </td>
						</tr>";
