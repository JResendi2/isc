...
//$_pagi_totalReg = @mysqli_result($_pagi_result2,0,0);	// Total de registros xxx - Se ha agregado @ para evitar que se muestre error cuando los registros son 0
$_Num_regis_Consul = mysqli_num_rows($_pagi_result); 	// Agregamos esta linea xxx
}else{
$_pagi_result3 = mysqli_query($conexion,$_pagi_sql);
// Si ocurrió error y mostrar errores está activado
