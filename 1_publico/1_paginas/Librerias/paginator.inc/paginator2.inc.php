<?php
// PAGINATOR ACTUALIZADO A LA VERSION 5.3 DE PHP. Fecha de actualización: 17-06-2013

/* Esta actualizacion ha sido realizada por UTERRA.COM
WWW.UTERRA.COM
...
$_pagi_totalReg = @mysql_result($_pagi_result2,0,0);	// Total de registros xxx - Se ha agregado @ para evitar que se muestre error cuando los registros son 0
$_Num_regis_Consul = mysql_num_rows($_pagi_result); 	// Agregamos esta linea xxx
}else{
...
if ($enlacesdepaginacion > 0) 	// Modificacion que permite definir el numero de enlaces de paginación xxx
{ 
