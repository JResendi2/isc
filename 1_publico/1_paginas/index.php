...
$consulta = "select id, titulo, informacion from contenidos";
...
<body>
	<header>
		<nav class="contenedor-menu">
			<div>
				<li class="menus--select" style="display:flex; align-items:center; "><a class="menus " href="index.php">
	...
	<section class="container">
		...
		while ($registro = mysqli_fetch_array($resultado_de_la_consulta)) { // Mientras existan registros...
			...
			$sql = "select id, nombre from imagenes where ids = '" . $registro['id'] . "' and tipo = 'contenido'";
			...
			$archivos = "select id, nombre, nombreunico from archivos where ids = '" . $registro['id'] . "' and tipo = 'contenido'";
