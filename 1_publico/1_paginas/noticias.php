...
$consulta = "select id, titulo, informacion from avisos where tipo_informacion = 'noticia'";
...
<body>
	<header>
		<nav class="contenedor-menu">
			<div>
				...
				<li><a class="menus menus--select" href="noticias.php">
						NOTICIAS
					</a> </li>
	...
	<section class="container">
		...
		while ($registro = mysqli_fetch_array($resultado_de_la_consulta)) { // Mientras existan registros...
			...
			$sql = "select id, nombre from imagenes where ids = '" . $registro['id'] . "' and tipo = 'noticia'";
			...
			$archivos = "select id, nombre, nombreunico from archivos where ids = '" . $registro['id'] . "' and tipo = 'noticia'";
